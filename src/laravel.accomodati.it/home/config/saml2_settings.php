...
return $settings = array(
     ...
     *    Method | URI                                | Name             |
     *    -------|------------------------------------|------------------|---------------------------------------------------
     *    POST   | {routesPrefix}/{idpName}/acs       | saml_acs         | https://laravel.accomodati.it/saml2/laravelsso/acs
     *    GET    | {routesPrefix}/{idpName}/login     | saml_login       | https://laravel.accomodati.it/saml2/laravelsso/login
     *    GET    | {routesPrefix}/{idpName}/logout    | saml_logout      | https://laravel.accomodati.it/saml2/laravelsso/logout
     *    GET    | {routesPrefix}/{idpName}/metadata  | saml_metadata    | https://laravel.accomodati.it/saml2/laravelsso/metadata
     *    GET    | {routesPrefix}/{idpName}/sls       | saml_sls         | https://laravel.accomodati.it/saml2/laravelsso/sls
     */
    'useRoutes' => true,
